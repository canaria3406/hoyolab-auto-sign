...
> \[!IMPORTANT\]
> HoYoLAB изменил куки на HttpOnly. Теперь невозможно считывать файлы куки с использованием кода getToken.js.\
...
1. **myDiscordID** - Введите свой user ID от Discord.
   ...
   Если вы хотите, чтобы вас уведомляли при неудачном сборе наград.
...
1. **telegramBotToken** - Введите свой токен Telegram-бота.
   ...
   Скопируйте свой токен Telegram-бота и вставте его в "кавычки".
